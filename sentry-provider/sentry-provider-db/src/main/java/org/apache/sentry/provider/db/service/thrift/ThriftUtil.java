...
public final class ThriftUtil {
   ...
   */
  public static void parseHostPortStrings(String[] hostsAndPortsArr,
                                          HostAndPort[] hostsAndPorts, int defaultPort) {
    Preconditions.checkArgument(hostsAndPortsArr.length == hostsAndPorts.length);
